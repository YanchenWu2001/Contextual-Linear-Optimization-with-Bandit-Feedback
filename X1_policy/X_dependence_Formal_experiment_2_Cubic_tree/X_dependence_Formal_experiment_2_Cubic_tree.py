...
for i in range(len(n_train_seq)):
    ...
    pd.concat(validation_all_Linear_Wrong_Double_Robust_Tree_Sigma).to_csv("validation_no_kernel_Linear_Wrong_Double_Robust_Tree_Sigma.csv", index = False)
    ...
    pd.concat(Clip_validation_all_Linear_Wrong_Double_Robust_Tree_Sigma).to_csv("validation_no_kernel_Clip_Linear_Wrong_Double_Robust_Tree_Sigma.csv", index = False)
    ...
    pd.concat(Lambda_validation_all_Linear_Wrong_Double_Robust_Tree_Sigma).to_csv("validation_no_kernel_Lambda_Linear_Wrong_Double_Robust_Tree_Sigma.csv", index = False)
