...
for i in range(len(n_train_seq)):
    ...
    res_temp = Parallel(n_jobs = n_jobs, verbose = 3)(delayed(replication_no_kernel)(
                            ...
                            data_train[run][0][:, :n_train_true], data_train[run][1][:, :n_train_true], data_train[run][10][:, :n_train_true], data_train[run][10][:, :n_train_true],
                            data_holdout[run][0][:, :n_holdout_true], data_holdout[run][1][:, :n_holdout_true], data_holdout[run][10][:, :n_holdout_true], data_holdout[run][10][:, :n_holdout_true],
